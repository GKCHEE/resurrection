        ...
        <section className="space-y-12">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border-l-8 border-[#10B981]">
            ...
            <div className="space-y-4 text-lg md:text-xl leading-relaxed text-slate-800">
              ...
              <p>To maintain absolute control, he orchestrated a 20-year Digital Blackout. I was forced to live without a cell phone or internet from the early 2000s until 2025, completely isolated from my parents, relatives, and friends. I was a ghost in my own life, unable to verify his lies or seek help.The fraud was an orchestrated process of relentless extraction. The predator—a Malaysian Chinese physician who operated with a 'tough-guy' dominance—demanded every penny of my wages immediately upon receipt. He was indifferent to professional boundaries or status. For over two decades, he manipulated my oxygen-starved vulnerability, forcing hand-overs of physical cash in bags at his clinic. After his retirement, his 'intentional rush' to liquidate my SGD $90,000 CPF savings continued at a public bus stop. His 'intentional rush' to liquidate my SGD $90,000 CPF savings and ongoing wages was enforced through constant gaslighting and psychological intimidation. This transition from a professional setting to the street proves the 'Exit Scam' nature of his fraud, leaving me homeless and a 'stray' while he lived off my life’s work while I operated at 50% biological capacity.</p>
            </div>
          </div>
